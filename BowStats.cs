...
namespace AlweStats {
    public static class BowStats {
        ...
        public static void Update() {
            ...
            if (localPlayer) {
                if (Main.enableBowStats.Value && bowBlock != null) {
                ...
                if (Main.customBowCharge.Value && bowCharge != null) {
                    ...
                    bowCharge.SetColor(Color.Lerp(new Color(1f, 1f, 1f, 0f), bowBlock.StringToColor(Main.bowChargeBarColor.Value), bowPerc));
