...
namespace AlweStats {
    public static class EditingMode {
        ...
        private static readonly Transform[] inGameOriginals = new Transform[3];
        private static readonly List<GameObject> templateObjs = new(3);
        private static Vector3 lastMousePos = Vector3.zero;
        private static string currentlyDragging = "";

        public static void Start() {
            inGameOriginals[0] = Hud.instance.transform.Find("hudroot").Find("GameStats");
            inGameOriginals[1] = Hud.instance.transform.Find("hudroot").Find("WorldStats");
            inGameOriginals[2] = Hud.instance.transform.Find("hudroot").Find("WorldClock");
        ...
        public static void Update() {
            ...
            if (Input.GetKey(KeyCode.Mouse0)) {
                if (currentlyDragging != "") {
                    Transform current = Hud.instance.transform.Find("hudroot").Find(currentlyDragging);
        ...
        public static void OnPress() {
            ...
            if (isEditing) {
                ...
                foreach (GameObject g in templateObjs) {
                    RectTransform originalRT = Hud.instance.transform.Find("hudroot").Find(g.name.Replace("Template", "")).GetComponent<RectTransform>();
                ...
                foreach (GameObject g in templateObjs) {
                    Transform gameOriginal = Hud.instance.transform.Find("hudroot").Find(g.name.Replace("Template", ""));
        ...
        private static void Reset() {
            isEditing = false;
            Vector2[] positions = { new Vector2(0f, 0f), new Vector2(1f, 0f), new Vector2(0.5f, 1f) };
            Vector2[] margins = { new Vector2(5f, 5f), new Vector2(-5f, 5f), new Vector2(0f, 0f) };
